...
TestObject VisitApps = new TestObject('VisitApps')
VisitApps.addProperty(
	'xpath', 
	ConditionType.EQUALS, 
	"//a[@href='/kunjungan-tamu/dashboard' and .//p[text()='Visitors Management']]")

WebUI.waitForElementClickable(VisitApps, 10)
WebUI.click(VisitApps)

// Step 3: Verifikasi halaman muncul
// Membuat TestObject secara dinamis
TestObject Visit = new TestObject('Visit')
Visit.addProperty('xpath', 
	ConditionType.EQUALS, 
	"//span[text()='Visitor Attendance' and contains(@class, 'MuiTypography-caption')]")

// Verifikasi bahwa elemen muncul
WebUI.verifyElementPresent(Visit, 10)
